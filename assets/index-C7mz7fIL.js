...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>{const t=`mailto:${e.email}`;return U.jsxs("div",{className:"CommentInfo",children:[U.jsxs("div",{className:"CommentInfo__title",children:[U.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",U.jsx("a",{className:"CommentInfo__email",href:t,children:e.email})]}),U.jsx("div",{className:"CommentInfo__body",children:e.body})]})},Lc=({comments:e})=>U.jsx("div",{className:"CommentList",children:e.map(t=>U.jsx(Pc,{comment:t},t.id))}),Tc=({postInfo:e})=>{const{user:t,post:i,comments:n}=e,a=`mailto:${t.email}`;return U.jsxs("div",{className:"PostInfo",children:[U.jsxs("div",{className:"PostInfo__header",children:[U.jsx("h3",{className:"PostInfo__title",children:i.title}),U.jsxs("p",{children:[" Posted by  ",U.jsx("a",{className:"UserInfo",href:a,children:t.name})]})]}),U.jsx("p",{className:"PostInfo__body",children:i.body}),U.jsx("hr",{}),n.length!==0?U.jsx(Lc,{comments:n}):U.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})},Mc=({posts:e})=>U.jsx("div",{className:"PostList",children:e.map(t=>U.jsx(Tc,{postInfo:t},t.post.id))});function Rc(e,t){return e.find(i=>t===i.id)||null}function Dc(e,t){return e.filter(i=>i.postId===t)}const jc=Cc.map(e=>{const t=Rc(Nc,e.userId),i=Dc(zc,e.id);return{user:t,post:e,comments:i}}),Oc=()=>U.jsxs("section",{className:"App",children:[U.jsx("h1",{className:"App__title",children:"Static list of posts"}),U.jsx(Mc,{posts:jc})]});em(document.getElementById("root")).render(U.jsx(Oc,{}));
